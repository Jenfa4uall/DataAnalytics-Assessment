...
SELECT 
    ...
    FORMAT(SUM(s.confirmed_amount)/100,2) AS total_deposits -- The total deposit field is converted from kobo to Naira by dividing by 100 and standardize the formatting. 
FROM plans_plan p 
